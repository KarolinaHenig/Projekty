...
public class Kredyt2BB {
	...
	public boolean rata () {
		try {
			...
			ctx.addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO, "Wysokoœæ raty to: "+ result + " z³", null));
			return true;
		}
		catch (Exception e) {
			ctx.addMessage(null,
	...
	public String calc_AJAX() {
		if (rata()) {
			ctx.addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO,   result+" z³", null));
		}
		return null;
	}
	public String info() {
